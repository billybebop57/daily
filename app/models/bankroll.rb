...
## General Distribution of League Play: H2H - 70%, 50/50 - 20%, Tournament - 5%, Other - 5%
...
class Bankroll
	...
	def league_payout(payout)
		expected_winning_percentage = payout.percentage
		expected_losing_percentage = (1.0 - expected_winning_percentage)
		((expected_losing_percentage/6) * (expected_winning_percentage) * (@bankroll)).round(2)
	end
